...
export default function Product32() {
  const [slide, setSlide] = useState(productimages[data[7].image1])
 ...
 const nextSlide = () => {
  console.log('click')
    if (slide == productimages[data[7].image1]) {
      setSlide(productimages[data[7].image2])
    } else {
      setSlide(productimages[data[7].image1])
    }
  }
