...
export default function Product33() {
 ...
 const nextSlide = () => {
  ...
  return (
    <Wrapper>
      <p className="breadcrumbs"><Link to="/">Home</Link> <img src="../images/right-arrow.svg" /> <Link to="/producten">Producten</Link> <img src="../images/right-arrow.svg" /> <Link to={`/${data[8].category}`}>Halsbanden</Link> <img src="../images/right-arrow.svg" /> {data[8].productname}</p>
