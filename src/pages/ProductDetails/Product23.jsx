...
export default function Product23() {
 ...
 const nextSlide = () => {
  ...
  return (
    <Wrapper>
      <p className="breadcrumbs"><Link to="/">Home</Link> <img src="../images/right-arrow.svg" /> <Link to="/producten">Producten</Link> <img src="../images/right-arrow.svg" /> <Link to={`/${data[5].category}`}>Speelgoed</Link> <img src="../images/right-arrow.svg" /> {data[5].productname}</p>
